...
public class SetShooter extends Command {
    ...
    @Override
    protected void init() {
        double speed = flywheelSpeed == FlywheelSpeed.LIMELIGHT ? input.getShooterInput().getLimelightFlywheelSpeed() : flywheelSpeed.getValue();
    ...
    protected boolean endCondition() {
        // Stop if flywheel speed is 0 (natural ramp down) or the speed is +/- 200 of requested
